...
# create and save refernce for the table
...
def home():
    return(
        f"Welcome to the Hawaii CLimate Data Homepage<br/>"
         f"Precipitation Scores over past Year: <a href=\"/api/v1.0/precipitation\">/api/v1.0/precipitation<a><br/>"
        f"Active Station Weather Data: <a href=\"/api/v1.0/stations\">/api/v1.0/stations<a><br/>"
        f"Temperature Observations for Station (ID USC00519281) ever past Year: <a href=\"/api/v1.0/tobs\">/api/v1.0/tobs<a><br/>"
        f"Minimum, Average & Maximum Temperatures within Date Range: <a href=/api/v1.0/trip/yyyy-mm-dd/yyyy-mm-dd<br>"
    )
